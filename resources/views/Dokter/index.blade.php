...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
              <div class="breadcrumb-title pe-3">DATA TABLE - DOKTER</div>
              <div class="ps-3">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                   <h5 class="mb-0 text-uppercase">Data Dokter</h5>
                  ...
                  <table class="table align-middle mb-0">
                    ...
                    <th width="280px">ACTION</th>
                     ...
                     <tbody> 
                        ...
                        <td>@if($dokter->photo)
                          <img src="{{ asset('images/'.$dokter->photo) }}" alt="{{ $dokter->nama }}" style="max-width: 100px;">
